  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="w-full bg-white overflow-hidden relative pb-20 md:pb-34 pt-4 md:pt-0">
        <h2
          className="absolute right-4 md:right-12 lg:right-48 top-16 md:top-auto md:bottom-[calc(7rem+20px)] lg:bottom-[calc(10rem+20px)] xl:bottom-[calc(10rem+20px)] text-white text-4xl sm:text-4xl md:text-6xl lg:text-[118px] xl:text-[178px] font-bold leading-[110%] pointer-events-none z-10"
          style={{ fontFamily: "norman-variable, sans-serif", mixBlendMode: "difference" }}
        >
          2025
        </h2>
        <h2
          className="absolute left-8 md:left-12 lg:left-38 top-4 md:top-auto md:bottom-[15rem] lg:bottom-[22rem] xl:bottom-[26rem] text-black md:text-white text-5xl sm:text-4xl md:text-6xl lg:text-[118px] xl:text-[178px] font-bold leading-[110%] pointer-events-none z-10"
          style={{ fontFamily: "norman-variable, sans-serif" }}
        >
          Impressionen
        </h2>
        <div data-gallery="horizontal-scroll" className="flex items-center gap-4 md:gap-6 lg:gap-[35px] px-4 md:px-8 lg:px-12 mb-8 md:mb-12 mt-20 md:mt-0" style={{ transition: 'transform 0.05s linear', willChange: 'transform' }}>
      ...
      <section className="w-full bg-white py-24 md:py-48 lg:py-64">
        <div className="max-w-7xl px-4 md:px-8 lg:px-16">
          <p
            className="text-foreground text-4xl sm:text-4xl md:text-5xl lg:text-[68px] font-black leading-[110%] tracking-tight"
      ...
      <section className="w-full bg-white overflow-hidden">
        ...
        <div className="w-full bg-black pt-2 pb-18 md:pt-2 md:pb-22 lg:pt-10 lg:pb-40">
          <div className="w-full pl-4 pr-4 md:pl-8 md:pr-8 lg:pl-16 lg:pr-16">
            <h2
              className="text-white font-bold text-5xl sm:text-5xl md:text-7xl lg:text-[118px] xl:text-[198px] leading-[110%] mb-12 md:mb-24 lg:mb-48"
              style={{ fontFamily: "norman-variable, sans-serif" }}
            >
              Model Me
            </h2>
            ...
            <div className="flex flex-col gap-16 md:gap-24 lg:gap-36">
              ...
              <div className="flex flex-col md:flex-row items-start gap-6 md:gap-12 lg:gap-[70px]">
                <p
                  className="text-white font-bold text-7xl md:text-8xl lg:text-[148px] xl:text-[198px] leading-[110%] md:min-w-[200px] lg:min-w-[300px] xl:min-w-[400px]"
                  style={{ fontFamily: "norman-variable, sans-serif" }}
                >
                  01
                </p>
                <div className="flex flex-col gap-4 md:gap-6 lg:gap-[35px]">
                  <p
                    className="text-white text-3xl md:text-4xl lg:text-[68px] font-black leading-[100%]"
                    style={{ fontFamily: "Public Sans", lineHeight: "1" }}
                  >
                    Casting – dein Startmoment
                  </p>
                  <p className="text-white font-inter text-base md:text-lg lg:text-[26px] font-light !leading-[1.3] max-w-2xl">
      ...
      <section className="w-full bg-white overflow-hidden relative pb-16 md:pb-24 lg:pb-32">
        {/* Text overlay */}
        <h2
          className="absolute left-4 md:left-12 lg:left-48 bottom-16 md:bottom-24 lg:bottom-36 text-white text-5xl sm:text-5xl md:text-7xl lg:text-[118px] xl:text-[198px] font-bold leading-[110%] pointer-events-none z-10 whitespace-nowrap"
          style={{ fontFamily: "norman-variable, sans-serif", mixBlendMode: "difference" }}
        >
          einfach du
        </h2>
        ...
        <div className="w-full pl-4 pr-0 md:pl-8 md:pr-0 lg:pl-16 lg:pr-0">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-12 lg:gap-24">
            {/* Left column */}
              ...
              <p
                className="text-foreground text-4xl sm:text-4xl md:text-5xl lg:text-[68px] font-black leading-[110%]"
                style={{ fontFamily: "Public Sans" }}
              >
      ...
      <section className="w-full bg-white pb-16 md:pb-24 lg:pb-32">
        <div className="w-full pl-4 pr-4 md:pl-8 md:pr-8 lg:pl-16 lg:pr-16">
          <h2
            className="text-foreground text-4xl sm:text-4xl md:text-5xl lg:text-[68px] font-black leading-[110%] mb-8 md:mb-12 lg:mb-16"
            style={{ fontFamily: "Public Sans" }}
          >
            FAQ
          </h2>
          ...
          <Accordion type="single" collapsible className="w-full">
            {[
              ...
              <AccordionItem key={index} value={`item-${index}`} className="border-b border-border py-3 md:py-4">
                ...
                >
                  <span className="text-foreground font-inter text-base md:text-lg lg:text-[26px] font-semibold leading-relaxed text-left">
                    {item.question}
                  </span>
                  <div className="flex-shrink-0 ml-4">
                    <img src={arrowDown} alt="" className="arrow-down w-8 h-8 md:w-8 md:h-8 lg:w-[45px] lg:h-[45px]" />
                    <img src={arrowUp} alt="" className="arrow-up w-8 h-8 md:w-8 md:h-8 lg:w-[45px] lg:h-[45px]" />
                  </div>
                </AccordionTrigger>
                <AccordionContent>
                  <p className="text-foreground font-inter text-base md:text-lg lg:text-[26px] font-light leading-[1.3] pt-3 md:pt-4 pr-12 md:pr-16 lg:pr-20">
                    {item.answer}
                  </p>
                </AccordionContent>
              </AccordionItem>
      ...
      <section className="w-full bg-white mt-24 md:mt-48">
        <div className="w-full pl-4 pr-4 md:pl-8 md:pr-8 lg:pl-16 lg:pr-16">
          <p
            className="text-black font-bold text-5xl sm:text-5xl md:text-7xl lg:text-[118px] xl:text-[198px] leading-[110%]"
            style={{ fontFamily: "norman-variable, sans-serif" }}
          >
            Mediale
          </p>
        ...
        <div className="w-full bg-black py-12 pb:-10 md:py-10 md:pb-12 lg:py-12 lg:pb-40">
          <div className="w-full pl-4 pr-4 md:pl-8 md:pr-8 lg:pl-16 lg:pr-16">
            <h2
              className="text-white font-bold text-5xl sm:text-5xl md:text-7xl lg:text-[118px] xl:text-[198px] leading-[110%] mb-12 md:mb-24"
              style={{ fontFamily: "norman-variable, sans-serif" }}
            >
              Berichterstattung
            </h2>
      ...
      <section className="w-full bg-white py-16 md:py-24 lg:py-32">
        <div className="w-full">
          <h2
            className="text-foreground text-4xl sm:text-4xl md:text-5xl lg:text-[68px] font-bold leading-[110%] tracking-tight pl-4 pr-4 md:pl-8 md:pr-8 lg:pl-16 lg:pr-16"
            style={{ fontFamily: "Public Sans" }}
          >
            Unsere Partner
          </h2>
        ...
        <div className="w-full pl-4 pr-4 md:pl-8 md:pr-8 lg:pl-16 lg:pr-16">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-6 md:gap-8">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-white font-bold text-xl md:text-xl lg:text-[26px]" style={{ fontFamily: "Public Sans" }}>
                Model Me
              </span>
              <span className="font-inter text-xl md:text-xl lg:text-[26px] font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 md:mt-10">
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              <span className="text-white font-inter text-xl md:text-xl lg:text-[26px] font-light">Die Reise</span>
              <span className="text-white font-inter text-xl md:text-xl lg:text-[26px] font-light">FAQ</span>
              <span className="text-white font-inter text-xl md:text-xl lg:text-[26px] font-light">Impressionen</span>
            </div>

            {/* Right Navigation */}
            <div className="flex flex-col gap-4 md:gap-6 md:items-end">
              <a href="#" className="text-white font-inter text-xl md:text-xl lg:text-[26px] font-light underline">
                Kontakt
              </a>
              <a href="#" className="text-lime font-inter text-xl md:text-xl lg:text-[26px] font-light underline">
          ...
          <div className="flex justify-center mt-8 md:mt-10">
            <img src={volLogoFooter} alt="VOL.AT Logo" className="h-12 md:h-12 lg:h-[60px]" />
          </div>

          {/* Footer Bottom Text */}
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 lg:gap-16 mt-6 md:mt-8 text-center">
            <span className="text-white font-inter text-sm md:text-lg lg:text-[26px] font-light">Impressum</span>
            <span className="text-white font-inter text-sm md:text-lg lg:text-[26px] font-light">© 2026 Alle Rechte vorbehalten</span>
            <span className="text-white font-inter text-sm md:text-lg lg:text-[26px] font-light">Datenschutz</span>
          </div>
        </div>
      </footer>
    </div>
