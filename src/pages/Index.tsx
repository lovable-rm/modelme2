    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative h-[80vh] md:min-h-screen w-full">
        ...
        <h1
          ...
          className="absolute bottom-0.5 left-0 right-0 text-right md:text-center text-white text-[80px] md:text-7xl lg:text-[118px] xl:text-[200px] px-4 pr-8 md:pl-12 lg:pl-24 xl:pl-[400px] -mb-2 md:-mb-6 lg:-mb-8 whitespace-nowrap"
          style={{
